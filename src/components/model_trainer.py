    ...
    def initiate_Model_trainer(self,train_array,test_array):
        try:
            ...
            models = {
                ...
                'AdaBoost regressor': AdaBoostRegression(), 
            }
            params = {
                'Decision Tree':{
            ...
            model_report:dict = evaluate_models(X_trains=X_train,y_train=y_train,X_test=X_test,y_test=y_test,models=models,param=params)
